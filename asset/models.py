...
class Asset(models.Model):
    ...
    status = models.IntegerField(choices=ASSET_STATUS, null=True, blank=True, default=1,
    ...
    use = models.ManyToManyField(to="ServerUse", blank=True, related_name='serveruse_asset',
...
class Idc(models.Model):
    ...
    cabinet_info = models.CharField(max_length=30, blank=True, null=True, default=None,
                                    verbose_name=_('Cabinet information'))
