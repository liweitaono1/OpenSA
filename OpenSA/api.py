...
import numpy as np
import paramiko
from ansible.modules.system.authorized_key import keyfile
from django.contrib.auth.mixins import LoginRequiredMixin
from django.http import HttpResponseRedirect, HttpResponse
from django.views import View

from OpenSA.settings import STATIC_DIR, DATA_DIR
from users.models import UserProfile, Project, RoleList
...
class Connection(object):
    def __init__(self, ip, user, port=22, key='/root/.ssh/id_rsa', remote_file='/tmp', local_dir=None, remote_dir=None,
                 password=None, timeout=300):
        self.ip = ip
        self.user = user
        self.port = int(port)
    ...
    def __call__(self, request, *args, **kwargs):
        ...
        try:
            ...
            if request.method == 'POST':
                ...
                request_type = 0
            if request.path or 'audit' in request.path or '/toastr.js.map' in request.path:
                pass
