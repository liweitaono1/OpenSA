...
class JobsResults(models.Model):
    ...
    key = models.ForeignKey(to="users.KeyManage", blank=True, null=True, verbose_name=_('Jobs Exec Key'),
                            on_delete=models.SET_NULL)
    task_schedule = models.ManyToManyField(to='TaskSchedule', blank=True, verbose_name=_("Jobs Schedule"))
    project = models.ForeignKey(to="users.Project", null=True, blank=True, on_delete=models.SET_NULL,
                                verbose_name=_("Jobs Project"))
