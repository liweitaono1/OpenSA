...
from users.models import UserProfile, DepartMent, MenuList, PermissionList, KeyManage, Project
...
class GroupsForm(forms.ModelForm):
    ...
    def __init__(self, **kwargs):
        ...
        super(GroupsForm, self).__init__(**kwargs)

    def save(self, commit=True):
        var = super(GroupsForm, self).save(commit=commit)
...
class ProjectForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        var = super(ProjectForm, self).save(commit=commit)
        users = self.cleaned_data['username']
        var.userprofile_set.set(users)
        return vars
...
class ProjectFormAdd(forms.ModelForm):
    ...
    def __init__(self, **kwargs):
        ...
        if instance:
            ...
            kwargs['initial'] = initial
        super(ProjectFormAdd, self).__init__(**kwargs)
